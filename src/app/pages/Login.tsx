...
export function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    else setError(result.error || "Invalid credentials. Try again.");
  };
  ...
  const handleGoogle = async () => {
    ...
    if (result.success) navigate("/dashboard");
    else setError(result.error || "Google sign-in is unavailable.");
  };
    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={stat.label} className="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-center">
                <p className="text-white" style={{ fontSize: "20px", fontWeight: 700 }}>{stat.value}</p>
                <p className="text-indigo-200" style={{ fontSize: "11px" }}>{stat.label}</p>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="text-white" style={{ fontSize: "13px", fontWeight: 600 }}>Sophia Chen</p>
                <p className="text-indigo-300" style={{ fontSize: "11px" }}>UI/UX Designer</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h1 className="text-slate-900 mb-2" style={{ fontSize: "28px", fontWeight: 700 }}>Welcome back</h1>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all mb-6 disabled:opacity-60"
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-slate-400" style={{ fontSize: "12px" }}>or sign in with email</span>
            <div className="flex-1 h-px bg-slate-200" />
          </div>
