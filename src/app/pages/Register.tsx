        ...
        <div className="w-full max-w-lg">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-500" style={{ fontSize: "14px" }}>
              {step === 1
                ? "A simple profile is enough to start making credible matches."
                : step === 2
                  ? "Share what you're genuinely comfortable teaching others."
                  : "Choose the skills you'd be excited to learn from the community."}
            </p>
          </div>
